...
function noteblog_customize_register( $wp_customize ) {
	...
	$wp_customize->add_section(
		'noteblog_rating',
		array(
			'title' => __('Rate Noteblog <3', 'noteblog'),
			'priority' => 995,
			'description' => __('We work hard & do our best to give you an awesome theme. If you like Noteblog then let the developer know, he gets so happy!', 'noteblog') . '<br> <br><a class="button button-primary" href="https://wordpress.org/support/theme/noteblog/reviews/?filter=5" target="_blank">Click here to rate Noteblog</a> ',
			)
		);  
	$wp_customize->add_setting('noteblog_rating[info]', array(
		'sanitize_callback' => 'noteblog_no_sanitize',
		'type' => 'info_control',
		'capability' => 'edit_theme_options',
		)
	...
	$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'rating_section', array(
		'section' => 'noteblog_rating',
		'settings' => 'noteblog_rating[info]',
		'type' => 'textarea',
		'priority' => 105
		) )
	);   
