...
class Info_PRO_Control extends Info_Control
{
    ...
    public function active_callback() {
        $active =  apply_filters('mesmerize_show_info_pro_messages', false);
        return $active;
	}
        ...
        ?>
        	<li id="accordion-section-<?php echo esc_attr( $this->id ); ?>" class="<?php echo esc_attr( $classes ); ?>">
				<div class="ope-pro-header accordion-section-title">
                    <a href="//extendthemes.com/mesmerize/#pricing" target="_blank" class="button"><?php _e("Upgrade to PRO",'mesmerize') ?></a>
				</div>
			</li>
